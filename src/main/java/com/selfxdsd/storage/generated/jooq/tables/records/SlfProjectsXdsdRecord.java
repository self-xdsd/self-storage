...
public class SlfProjectsXdsdRecord extends UpdatableRecordImpl<SlfProjectsXdsdRecord> implements Record5<String, String, String, Integer, String> {

    private static final long serialVersionUID = -672012;
    ...
    @Override
    public SlfProjectsXdsdRecord value5(String value) {
        setWebhookToken(value);
        return this;
    }

    @Override
    public SlfProjectsXdsdRecord values(String value1, String value2, String value3, Integer value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlfProjectsXdsdRecord(String repoFullname, String provider, String username, Integer pmid, String webhookToken) {
        super(SlfProjectsXdsd.SLF_PROJECTS_XDSD);
