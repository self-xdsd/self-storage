...
public class SlfPmsXdsdRecord extends UpdatableRecordImpl<SlfPmsXdsdRecord> implements Record5<Integer, String, String, String, String> {

    private static final long serialVersionUID = -495421562;
    ...
    @Override
    public SlfPmsXdsdRecord values(Integer value1, String value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlfPmsXdsdRecord(Integer id, String provider, String accessToken, String username, String userid) {
        super(SlfPmsXdsd.SLF_PMS_XDSD);
