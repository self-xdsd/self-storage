...
public class SlfPmsXdsdRecord extends UpdatableRecordImpl<SlfPmsXdsdRecord> implements Record6<Integer, String, String, String, String, BigDecimal> {

    private static final long serialVersionUID = 543595544;
    ...
    @Override
    public SlfPmsXdsdRecord values(Integer value1, String value2, String value3, String value4, String value5, BigDecimal value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlfPmsXdsdRecord(Integer id, String provider, String accessToken, String username, String userid, BigDecimal commission) {
        super(SlfPmsXdsd.SLF_PMS_XDSD);
