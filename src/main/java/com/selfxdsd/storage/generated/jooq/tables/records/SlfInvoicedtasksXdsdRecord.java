...
public class SlfInvoicedtasksXdsdRecord extends UpdatableRecordImpl<SlfInvoicedtasksXdsdRecord> implements Record15<Integer, Integer, String, String, String, String, BigInteger, String, LocalDateTime, LocalDateTime, LocalDateTime, Integer, BigInteger, Boolean, BigInteger> {

    private static final long serialVersionUID = 2088680010;
    ...
    @Override
    public Row15<Integer, Integer, String, String, String, String, BigInteger, String, LocalDateTime, LocalDateTime, LocalDateTime, Integer, BigInteger, Boolean, BigInteger> valuesRow() {
    ...
    @Override
    public SlfInvoicedtasksXdsdRecord value15(BigInteger value) {
        setContributorcommission(value);
        return this;
    }

    @Override
    public SlfInvoicedtasksXdsdRecord values(Integer value1, Integer value2, String value3, String value4, String value5, String value6, BigInteger value7, String value8, LocalDateTime value9, LocalDateTime value10, LocalDateTime value11, Integer value12, BigInteger value13, Boolean value14, BigInteger value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlfInvoicedtasksXdsdRecord(Integer id, Integer invoiceid, String repoFullname, String username, String provider, String role, BigInteger value, String issueid, LocalDateTime assigned, LocalDateTime deadline, LocalDateTime invoiced, Integer estimationMinutes, BigInteger commission, Boolean ispullrequest, BigInteger contributorcommission) {
        super(SlfInvoicedtasksXdsd.SLF_INVOICEDTASKS_XDSD);
