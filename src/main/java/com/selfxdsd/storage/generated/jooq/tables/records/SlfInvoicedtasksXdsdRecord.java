...
public class SlfInvoicedtasksXdsdRecord extends UpdatableRecordImpl<SlfInvoicedtasksXdsdRecord> implements Record13<Integer, Integer, String, String, String, String, BigInteger, String, LocalDateTime, LocalDateTime, LocalDateTime, Integer, BigInteger> {

    private static final long serialVersionUID = 1914843476;
    ...
    @Override
    public Row13<Integer, Integer, String, String, String, String, BigInteger, String, LocalDateTime, LocalDateTime, LocalDateTime, Integer, BigInteger> valuesRow() {
    ...
    @Override
    public SlfInvoicedtasksXdsdRecord values(Integer value1, Integer value2, String value3, String value4, String value5, String value6, BigInteger value7, String value8, LocalDateTime value9, LocalDateTime value10, LocalDateTime value11, Integer value12, BigInteger value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SlfInvoicedtasksXdsdRecord(Integer id, Integer invoiceid, String repoFullname, String username, String provider, String role, BigInteger value, String issueid, LocalDateTime assigned, LocalDateTime deadline, LocalDateTime invoiced, Integer estimationMinutes, BigInteger commission) {
        super(SlfInvoicedtasksXdsd.SLF_INVOICEDTASKS_XDSD);
